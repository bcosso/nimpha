...
func (sing *SingletonTable) UpdateWorker(filterLogic *Filter, ctx *map[string]interface{}) interface{} {
	indexRow := 0
...
func (sing *SingletonIndex) UpdateWorkerIndex(tableName string, row map[string]interface{}) interface{} {
